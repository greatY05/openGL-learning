...
int main() {
	...
	Shader shaderGeometryPass("gbuffer.vs", "gbuffer.frag");
	Shader shaderLightingPass("deferredShading.vs", "deferredShading.frag");
	Shader shaderLightBox("deferredLightBox.vs", "deferredLightBox.frag");
...
// -----------
	...
	//g buffer setup and framebuffer handling
...
// -------------
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// 1. geometry pass: render scenes geometry and color data into gbuffer
		glBindFramebuffer(GL_FRAMEBUFFER, gBuffer);
		...
		//lighting pass: calculate lighting by iterator over a screen filled quad pixel by pixel using the gbuffer content
		glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
		shaderLightingPass.use();
		...
		//blit the default framebuffer. fbo and default framebuffer has to match!
