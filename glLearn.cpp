...
int main() {
	...
	unsigned int albedo = loadTexture("rustyball/albedo.png", false);
	unsigned int normal = loadTexture("rustyball/normal.png", false);
	unsigned int metallic = loadTexture("rustyball/metallic.png", false);
	unsigned int roughness = loadTexture("rustyball/roughness.png", false);
	unsigned int ao = loadTexture("rustyball/ao.png", false);
